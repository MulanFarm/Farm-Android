...
public class P2PHandler {
	...
	public void setRemoteDefence(String contactId, String password, int value) {
		...
		Log.e(TAG,"contactId:"+contactId+"   password:"+password+ " value"+value);
	...
	public void iSetNPCSettings(int contactId, String password,int iMsgID, int iSettingID, int value) {
		MediaPlayer.iSetNPCSettings(contactId,
				Integer.parseInt(password),
				iMsgID,
				iSettingID,
				value);
	...
	//通用命令
	public void  iExtendedCmd(int contactId, int password,
										  int iMesgID, byte[] data, int datasize){
		MediaPlayer.iExtendedCmd(contactId,
				password, iMesgID, data ,datasize);
	};
